        ...
        <div className="w-full lg:w-2/3">
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
            {cartItems.length === 0 ? (
              ...
              <>
                {/* header */}
                <div className="hidden sm:grid grid-cols-[2fr-1fr-fr-1fr-auto] gap-4 text-gray-700 font-semibold mb-4">
                  <div>Products</div>
                  <div>Price</div>
                  <div>Quantity</div>
                  <div>Total Price</div>
                ...
                {cartItems.map((item, index) => (
                  <div
                    key={item.id}
                    className={`flex flex-col sm:grid sm:grid-cols-[2fr-1fr-1fr-1fr-auto] gap-4 items-start sm:items-center py-4 ${
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm sm:text-base text-gray-700 focus:outline-non focus:right-2 focus-ring-[#a91f64]"
                />
                <button className="text-white bg-[#a91f64] px-3 py-2 sm:px-4 sm:py-2 rounded-md hover:bg-[#8a1b54] text-sm sm:text-base cursor-pointer">
                  Apply
                </button>
              </div>
            </div>
